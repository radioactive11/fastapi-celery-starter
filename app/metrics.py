...
random_number_gauge = Gauge(
    "random_number_value", "Last generated random number"
)

# Gauge: Current active requests
active_requests = Gauge(
    "active_requests", "Number of active HTTP requests being processed"
)
...
active_celery_workers = Gauge(
    "active_celery_workers", "Number of active Celery workers"
)
